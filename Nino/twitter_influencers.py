...
class Twitter:
    ...
    def start_streaming(self, callback):
        ...
        twitter_stream.filter(follow=[TRUMP_USER_ID, POTUS_USER_ID, DIMON_USER_ID, CRAMER_USER_ID, BLANKFEIN_USER_ID])
...
class TwitterListener(StreamListener):
    ...
    def handle_data(self, logs, data):
        ...
        # We're only interested in tweets from group of influencers, so skip the
        # rest.
        if user_id_str != TRUMP_USER_ID, POTUS_USER_ID, DIMON_USER_ID, CRAMER_USER_ID, BLANKFEIN_USER_ID:
